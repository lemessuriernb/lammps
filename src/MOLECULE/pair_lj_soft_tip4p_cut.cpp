...
#include "pair_lj_soft_tip4p_cut.h"
...
PairLJSoftTIP4PCut::PairLJSoftTIP4PCut(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
  writedata = 1;
...
PairLJSoftTIP4PCut::~PairLJSoftTIP4PCut()
{
  if (allocated) {
...
void PairLJSoftTIP4PCut::compute(int eflag, int vflag)
{
...
void PairLJSoftTIP4PCut::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJSoftTIP4PCut::settings(int narg, char **arg)
{
...
void PairLJSoftTIP4PCut::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5)
...
void PairLJSoftTIP4PCut::init_style()
{
  if (atom->tag_enable == 0)
    error->all(FLERR,"Pair style lj/soft/tip4p/cut requires atom IDs");
  if (!force->newton_pair)
    error->all(FLERR,"Pair style lj/soft/tip4p/cut requires newton pair on");
  if (!atom->q_flag)
    error->all(FLERR,"Pair style lj/soft/tip4p/cut requires atom attribute q");
...
double PairLJSoftTIP4PCut::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJSoftTIP4PCut::write_restart(FILE *fp)
{
...
void PairLJSoftTIP4PCut::read_restart(FILE *fp)
{
...
void PairLJSoftTIP4PCut::write_restart_settings(FILE *fp)
{
...
void PairLJSoftTIP4PCut::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairLJSoftTIP4PCut::write_data(FILE *fp)
{
...
void PairLJSoftTIP4PCut::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
void PairLJSoftTIP4PCut::compute_newsite(double *xO,  double *xH1,
...
void *PairLJSoftTIP4PCut::extract(const char *str, int &dim)
{
  dim = 0;
...
double PairLJSoftTIP4PCut::memory_usage()
{
