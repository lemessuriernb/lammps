  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      if (rsq < cutsq[itype][jtype]) {
        ...
        if (eflag) {
          evdwl = r6inv * (lj3[itype][jtype] * r6inv) - offset[itype][jtype];
          evdwl *= factor_lj;
        }
...
void PairLJSoft::compute_middle()
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
  double xtmp, ytmp, ztmp, delx, dely, delz, fpair;
  double rsq, r2inv, r6inv, forcelj, factor_lj, rsw;
...
void PairLJSoft::compute_outer(int eflag, int vflag)
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
  double xtmp, ytmp, ztmp, delx, dely, delz, evdwl, fpair;
  double rsq, r2inv, r6inv, forcelj, factor_lj, rsw;
                         ...
                         double /*factor_coul*/, double factor_lj, double &fforce)
{
  ...
  philj = r6inv * (lj3[itype][jtype] * r6inv) - offset[itype][jtype];
  return factor_lj * philj;
}

/* ---------------------------------------------------------------------- */

void PairLJSoft::born_matrix(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
                            ...
                            double &du2pair)
{
  ...
  du = r6inv * rinv * (- lj1[itype][jtype] * r6inv);
  du2 = r6inv * r2inv * (13 * lj1[itype][jtype] * r6inv);
