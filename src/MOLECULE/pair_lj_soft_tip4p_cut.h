...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(lj/soft/tip4p/cut,PairLJSoftTIP4PCut);
// clang-format on
#else

#ifndef LMP_PAIR_LJ_SOFT_TIP4P_CUT_H
#define LMP_PAIR_LJ_SOFT_TIP4P_CUT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJSoftTIP4PCut : public Pair {
 public:
  PairLJSoftTIP4PCut(class LAMMPS *);
  ~PairLJSoftTIP4PCut() override;
